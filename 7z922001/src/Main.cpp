...
#include "../../UI/Common/Extract.h"					// パス変更
#ifdef EXTERNAL_CODECS
#include "../../UI/Common/LoadCodecs.h"					// パス変更
#endif

//#include "BenchCon.h"								    // 削除
#include "../../UI/Console/ExtractCallbackConsole.h"	// パス変更
#include "../../UI/Console/List.h"						// パス変更
#include "../../UI/Console/OpenCallbackConsole.h"		// パス変更
#include "../../UI/Console/UpdateCallbackConsole.h"		// パス変更
...
)
{
  ...
  #ifdef _WIN32
  NCommandLineParser::SplitCommandLine(g_StdOut.GetCommandLineW(), commandStrings);		// 変更
  #else
  ...
  CStdOutStream &stdStream = /* options.StdOutMode ? g_StdErr : */ g_StdOut;	// 変更
