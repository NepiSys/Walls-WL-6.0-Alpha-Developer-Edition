...
#endif
#include "../../../UI/Common/ArchiveOpenCallback.h"		// パス変更
...
public:
  ...
  HRESULT StartProgressDialog(const UString &title, NWindows::CThread &thread)
  {
    ...
    {
      #ifdef LANG
      ProgressDialog.SetText(LangLoadString(IDS_PROGRESS_EXTRACTING, 0x02000890));	// 変更
      #else
      ProgressDialog.SetText(NWindows::MyLoadStringW(IDS_PROGRESS_EXTRACTING));		// 変更
      #endif
    }
